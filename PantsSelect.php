...
$sql="SELECT * FROM PantsView";
$result = mysqli_query($con,$sql);
// Print the data from the table row by row
$col = 0;
while($row = mysqli_fetch_array($result)) {
  $Pants .= '<li>';
  $Pants .= '<img src="'. $row['imageLink'] .'" style="width:230px;height:230px;"/>';
  ...
  $Pants .= '<a href="buyNow.php?item_id='.$row['item_id'].'" style="color:blue">BUY</a>';
  $Pants .= '</li>';
}
mysqli_close($con);
$Pants .= '</ul>';
