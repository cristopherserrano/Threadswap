...
while($row = mysqli_fetch_array($result)) {
  $Scarves .= '<li>';
  $Scarves .= '<img src="'. $row['imageLink'] .'" style="width:230px;height:230px;"/>';
  ...
  $Scarves .= '<a href="buyNow.php?item_id='.$row['item_id'].'" style="color:blue">BUY</a>';
  $Scarves .= '</li>';
}
mysqli_close($con);
$Scarves .= '</ul>';
