...
while($row = mysqli_fetch_array($result)) {
  $Necklaces .= '<li>';
  $Necklaces .= '<img src="'. $row['imageLink'] .'" style="width:230px;height:230px;"/>';
  ...
  $Necklaces .= '<a href="buyNow.php?item_id='.$row['item_id'].'" style="color:blue">BUY</a>';
  $Necklaces .= '</li>';
}
mysqli_close($con);
$Necklaces .= '</ul>';
