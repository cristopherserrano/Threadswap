...
while($row = mysqli_fetch_array($result)) {
  $Earrings .= '<li>';
  $Earrings .= '<img src="'. $row['imageLink'] .'" style="width:230px;height:230px;"/>';
  ...
  $Earrings .= '<a href="buyNow.php?item_id='.$row['item_id'].'" style="color:blue">BUY</a>';
  $Earrings .= '</li>';
}
mysqli_close($con);
$Earrings .= '</ul>';
