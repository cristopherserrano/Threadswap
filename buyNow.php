...
$sql2="SELECT stock FROM clothing WHERE clothingID=$item_id";
...
$stock = $stock - 1;
if ($stock > 0) {
	$sql3="UPDATE clothing
		SET stock=$stock
		WHERE clothingID=$item_id";
} 
else {
  $sql3="UPDATE clothing
    SET stock=$stock
...
<a href='homepage.php' style='text-align:center;font-size: 300%;'>Keep Shopping</a>
