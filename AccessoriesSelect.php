...
while($row = mysqli_fetch_array($result)) {
  $Accessories .= '<li>';
  $Accessories .= '<img src="'. $row['imageLink'] .'" style="width:230px;height:230px;"/>';
  $Accessories .= '<h4>' . $row['name'] . '</h4>';
  $Accessories .= '<p name="item_id">' . $row['item_id'];
  ...
  $Accessories .= '<a href="buyNow.php?item_id='.$row['item_id'].'" style="color:blue">BUY</a>';
  $Accessories .= '</li>';
}
mysqli_close($con);
$Accessories .= '</ul>';
...
<script>
  ...
  function function2(){
    window.location.href = "test_search.html";
  }
